...
Factions:
  chat_prefix_faction: '&8[&6%faction_name%&8] %luckperms_prefix% &e%player% &f> &7%message%'
  chat_prefix_without_faction: '%luckperms_prefix% &e%player% &f> &7%message%'
...
- '§9/f home §7- Teleport to factions home'
